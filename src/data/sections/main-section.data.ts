...
const mainSectionData = {
  ...
  fullName: 'Onur Akbas',
  role: 'Service Product Specialist',
  details: [
    { label: 'Phone', value: '605 475 6961', url: 'tel:605 475 6961' },
    { label: 'Email', value: 'onurakbas@hotmail.co.uk', url: 'mailto:onurakbas@hotmail.co.uk' },
    { label: 'From', value: 'London, United Kingdom' },
    { label: 'Salary range', value: '18 000 - 25 000 PLN' },
  ],
  pdfDetails: [
    { label: 'Phone', value: '+447478613036' },
    { label: 'Email', value: 'onurakbas@hotmail.co.uk' },
